...
By default, the proposer will select a local prover to acquire the bond needed to propose a block. You can also specify a prover from the [prover market](/docs/reference/prover-market-page) by overriding the default value for:
